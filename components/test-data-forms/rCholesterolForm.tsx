...
const RCholesterolForm = ({ data, clearScreen }: { data: DataEmptyTests, clearScreen: () => void }) => {
        ...
        <div className="w-full">
            ...
            >
                ...
                <Form.Item label="Random Cholesterol" style={{ marginBottom: 0 }}>
                    ...
                    >
                        <Input addonAfter="mg/dl" placeholder="value" onChange={(e) => setFlag('rCholesterolValue', e.target.value)} />
                    </Form.Item>
                    <div className="flex-row items-center inline-flex">
                        ...
                        <span>
                            {displayNormalRange('rCholesterolValue')}
                        </span>
                    </div>
                </Form.Item>
