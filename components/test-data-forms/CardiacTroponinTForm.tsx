...
const CardiacTroponinTForm = ({ data, clearScreen }: { data: DataEmptyTests, clearScreen: () => void }) => {
                ...
                initialValues={
                    {
                        ...
                        "ctnt": data.data ? data.data?.ctnt : "Negative",
...
export default CardiacTroponinTForm;