                ...
                initialValues={
                    {
                        ...
                        "ppbsPostBfValue": data.data?.ppbsPostBfValue,
                        "ppbsPostBfValueFlag": data.data?.ppbsPostBfValueFlag,
                        "rbsPreLnValue": data.data?.rbsPreLnValue,
                        "rbsPreLnValueFlag": data.data?.rbsPreLnValueFlag,
                        "ppbsPostLnValue": data.data?.ppbsPostLnValue,
                        "ppbsPostLnValueFlag": data.data?.ppbsPostLnValueFlag,
                        "rbsPreDnValue": data.data?.rbsPreDnValue,
                        "rbsPreDnValueFlag": data.data?.rbsPreDnValueFlag,
                        "ppbsPostDnValue": data.data?.ppbsPostDnValue,
                        "ppbsPostDnValueFlag": data.data?.ppbsPostDnValueFlag,
