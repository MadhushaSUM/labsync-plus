...
const HIVForm = ({ data, clearScreen }: { data: DataEmptyTests, clearScreen: (testRegisterId: number, testId: number) => void }) => {
    ...
    const onFinish = async (values: any) => {
        try {
            const savingData = {
                hivAntigen: values.hivAntigen,
                hivAntibody: values.hivAntibody,
                ...
                initialValues={
                    {
                        ...
                        "hivAntigen": data.data ? data.data?.hivAntigen : "Negative",
                        "hivAntibody": data.data ? data.data?.hivAntibody : "Negative",
