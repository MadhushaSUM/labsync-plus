...
const ESRForm = ({ data, clearScreen }: { data: DataEmptyTests, clearScreen: (testRegisterId: number, testId: number) => void }) => {
    ...
    return (
        <div className="w-full">
                ...
                initialValues={
                    {
                        ...
                        "esr1sthrValue": data.data?.esr1sthrValue,
                        "esr1sthrValueFlag": data.data?.esr1sthrValueFlag,
            ...
            >
                ...
                <Form.Item label="ESR 1st hour" style={{ marginBottom: 0 }} >
                    <Form.Item
                        name="esr1sthrValue"
                        rules={[{ required: true }]}
                        style={{ display: 'inline-block', width: '200px' }}
                    >
                        <Input placeholder="value" onChange={(e) => setFlag('esr1sthrValue', e.target.value, investigationFieldsResults?.content, normalRangeRulesResults?.content, data.patientDOB, data.patientGender, form)} />
                    </Form.Item>
                    <div className="flex-row items-center inline-flex">
                        <Form.Item
                            name="esr1sthrValueFlag"
                        ...
                        <span>
                            {displayNormalRange('esr1sthrValue', investigationFieldsResults?.content, normalRangeRulesResults?.content, data.patientDOB, data.patientGender)}
                        </span>
                    </div>
                </Form.Item>
                <Form.Item
