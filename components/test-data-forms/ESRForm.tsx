...
const ESRForm = ({ data, clearScreen }: { data: DataEmptyTests, clearScreen: () => void }) => {
        ...
        <div className="w-full">
            ...
            >
                ...
                <Form.Item label="ESR 1st hour" style={{ marginBottom: 0 }} >
                    ...
                    >
                        <Input placeholder="value" onChange={(e) => setFlag('esr1sthrValue', e.target.value)} />
                    </Form.Item>
                    <div className="flex-row items-center inline-flex">
                        ...
                        <span>
                            {displayNormalRange('esr1sthrValue')}
                        </span>
                    </div>
                </Form.Item>
                <Form.Item
