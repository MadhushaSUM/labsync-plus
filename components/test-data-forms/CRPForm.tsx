...
const CRPForm = ({ data, clearScreen }: { data: DataEmptyTests, clearScreen: () => void }) => {
        ...
        <div className="w-full">
            ...
            >
                ...
                <Form.Item label="CRP Titre" style={{ marginBottom: 0 }} >
                    ...
                    >
                        <Input placeholder="value" onChange={(e) => setFlag('crpTitreValue', e.target.value)} disabled={crp == "Negative"} />
                    </Form.Item>
                    <div className="flex-row items-center inline-flex">
                        ...
                        <span>
                            {displayNormalRange('crpTitreValue')}
                        </span>
                    </div>
                </Form.Item>
                <Form.Item
