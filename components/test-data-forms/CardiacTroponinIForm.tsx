...
const CardiacTroponinIForm = ({ data, clearScreen }: { data: DataEmptyTests, clearScreen: (testRegisterId: number, testId: number) => void }) => {
                ...
                initialValues={
                    {
                        ...
                        "ctni": data.data ? data.data?.ctni : "Negative",
...
export default CardiacTroponinIForm;