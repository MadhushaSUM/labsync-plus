...
const BloodUreaForm = ({ data, clearScreen }: { data: DataEmptyTests, clearScreen: () => void }) => {
        ...
        <div className="w-full">
            ...
            >
                ...
                <Form.Item label="Blood Urea" style={{ marginBottom: 0 }}>
                    ...
                    >
                        <Input addonAfter="mg/dl" placeholder="value" onChange={(e) => setFlag('bloodUreaValue', e.target.value)} />
                    </Form.Item>
                    <div className="flex-row items-center inline-flex">
                        ...
                        <span>
                            {displayNormalRange('bloodUreaValue')}
                        </span>
                    </div>
                </Form.Item>
                <Form.Item
