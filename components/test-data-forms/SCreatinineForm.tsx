...
const SCreatinineForm = ({ data, clearScreen }: { data: DataEmptyTests, clearScreen: () => void }) => {
        ...
        <div className="w-full">
            ...
            >
                ...
                <Form.Item label="Serum creatinine" style={{ marginBottom: 0 }}>
                    ...
                    >
                        <Input addonAfter="mg/dl" placeholder="value" onChange={(e) => setFlag('sCreatinineValue', e.target.value)} />
                    </Form.Item>
                    <div className="flex-row items-center inline-flex">
                        ...
                        <span>
                            {displayNormalRange('sCreatinineValue')}
                        </span>
                    </div>
                </Form.Item>
                <Form.Item
