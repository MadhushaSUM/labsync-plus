...
const SCreatinineForm = ({ data, clearScreen }: { data: DataEmptyTests, clearScreen: (testRegisterId: number, testId: number) => void }) => {
    ...
    const onFinish = async (values: any) => {
        try {
            const savingData = {
                ...
                sCreatinineValueFlag: values.sCreatinineValueFlag,
    ...
    return (
        <div className="w-full">
                ...
                initialValues={
                    {
                        ...
                        "sCreatinineValueFlag": data.data?.sCreatinineValueFlag,
            ...
            >
                ...
                <Form.Item label="Serum creatinine" style={{ marginBottom: 0 }}>
                    <Form.Item
                        name="sCreatinineValue"
                        rules={[{ required: true }]}
                        style={{ display: 'inline-block', width: '200px' }}
                    >
                        <Input addonAfter="mg/dl" placeholder="value" onChange={(e) => setFlag('sCreatinineValue', e.target.value, investigationFieldsResults?.content, normalRangeRulesResults?.content, data.patientDOB, data.patientGender, form)} />
                    </Form.Item>
                    <div className="flex-row items-center inline-flex">
                        <Form.Item
                            name="sCreatinineValueFlag"
                        ...
                        <span>
                            {displayNormalRange('sCreatinineValue', investigationFieldsResults?.content, normalRangeRulesResults?.content, data.patientDOB, data.patientGender)}
                        </span>
                    </div>
                </Form.Item>
                <Form.Item
...
export default SCreatinineForm;