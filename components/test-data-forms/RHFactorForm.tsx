...
const RHFactorForm = ({ data, clearScreen }: { data: DataEmptyTests, clearScreen: (testRegisterId: number, testId: number) => void }) => {
        ...
        <div className="w-full">
            ...
            >
                ...
                <Form.Item label="Titre" style={{ marginBottom: 0 }} >
                    ...
                    >
                        <Input placeholder="value" onChange={(e) => setFlag('rhFactorTitreValue', e.target.value, investigationFieldsResults?.content, normalRangeRulesResults?.content, data.patientDOB, data.patientGender, form)} disabled={rhFactor == "Negative"} />
                    </Form.Item>
                    <div className="flex-row items-center inline-flex">
                        ...
                        <span>
                            {displayNormalRange('rhFactorTitreValue', investigationFieldsResults?.content, normalRangeRulesResults?.content, data.patientDOB, data.patientGender)}
                        </span>
                    </div>
                </Form.Item>
                <Form.Item
