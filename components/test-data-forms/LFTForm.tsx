...
const LFTForm = ({ data, clearScreen }: { data: DataEmptyTests, clearScreen: (testRegisterId: number, testId: number) => void }) => {
        ...
        <div className="w-full">
            ...
            >
                ...
                <Form.Item label="AST / SGOT" style={{ marginBottom: 0 }}>
                    ...
                    >
                        <Input addonAfter="U/L" placeholder="value" onChange={(e) => setFlag('sgotValue', e.target.value, investigationFieldsResults?.content, normalRangeRulesResults?.content, data.patientDOB, data.patientGender, form)} />
                    </Form.Item>
                    <div className="flex-row items-center inline-flex">
                        ...
                        <span>
                            {displayNormalRange('sgotValue', investigationFieldsResults?.content, normalRangeRulesResults?.content, data.patientDOB, data.patientGender)}
                        </span>
                    </div>
                </Form.Item>
                <Form.Item label="ALT / SGPT" style={{ marginBottom: 0 }}>
                    <Form.Item
                        ...
                        style={{ display: 'inline-block', width: '200px' }}
                    >
                        <Input addonAfter="U/L" placeholder="value" onChange={(e) => setFlag('sgptValue', e.target.value, investigationFieldsResults?.content, normalRangeRulesResults?.content, data.patientDOB, data.patientGender, form)} />
                    </Form.Item>
                    <div className="flex-row items-center inline-flex">
                        <Form.Item
                            name="sgptValueFlag"
                        ...
                        <span>
                            {displayNormalRange('sgptValue', investigationFieldsResults?.content, normalRangeRulesResults?.content, data.patientDOB, data.patientGender)}
                        </span>
                    </div>
                </Form.Item>
                ...
                <Form.Item label="S. Alkaline Phosphatase" style={{ marginBottom: 0 }}>
                    <Form.Item
                        ...
                        style={{ display: 'inline-block', width: '200px' }}
                    >
                        <Input addonAfter="U/L" placeholder="value" onChange={(e) => setFlag('sAlkalinePhosValue', e.target.value, investigationFieldsResults?.content, normalRangeRulesResults?.content, data.patientDOB, data.patientGender, form)} />
                    </Form.Item>
                    <div className="flex-row items-center inline-flex">
                        <Form.Item
                        ...
                        <span>
                            {displayNormalRange('sAlkalinePhosValue', investigationFieldsResults?.content, normalRangeRulesResults?.content, data.patientDOB, data.patientGender)}
                        </span>
                    </div>
                </Form.Item>
                ...
                <Form.Item label="Total Proteins" style={{ marginBottom: 0 }}>
                    <Form.Item
                        ...
                        style={{ display: 'inline-block', width: '200px' }}
                    >
                        <Input addonAfter="g/dl" placeholder="value" onChange={(e) => setFlag('totalProteinsValue', e.target.value, investigationFieldsResults?.content, normalRangeRulesResults?.content, data.patientDOB, data.patientGender, form)} />
                    </Form.Item>
                    <div className="flex-row items-center inline-flex">
                        <Form.Item
                        ...
                        <span>
                            {displayNormalRange('totalProteinsValue', investigationFieldsResults?.content, normalRangeRulesResults?.content, data.patientDOB, data.patientGender)}
                        </span>
                    </div>
                </Form.Item>
