...
const SCholesterolForm = ({ data, clearScreen }: { data: DataEmptyTests, clearScreen: () => void }) => {
        ...
        <div className="w-full">
            ...
            >
                ...
                <Form.Item label="S. Cholesterol" style={{ marginBottom: 0 }}>
                    ...
                    >
                        <Input addonAfter="mg/dl" placeholder="value" onChange={(e) => setFlag('sCholesterolValue', e.target.value)} />
                    </Form.Item>
                    <div className="flex-row items-center inline-flex">
                        ...
                        <span>
                            {displayNormalRange('sCholesterolValue')}
                        </span>
                    </div>
                </Form.Item>
