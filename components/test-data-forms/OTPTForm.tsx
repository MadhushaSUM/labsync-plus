...
const OTPTForm = ({ data, clearScreen }: { data: DataEmptyTests, clearScreen: () => void }) => {
        ...
        <div className="w-full">
            ...
            >
                ...
                <Form.Item label="SGOT (AST)" style={{ marginBottom: 0 }} >
                    ...
                    >
                        <Input placeholder="value" onChange={(e) => setFlag('sgotValue', e.target.value)} />
                    </Form.Item>
                ...
                <Form.Item label="SGPT (ALT)" style={{ marginBottom: 0 }} >
                    <Form.Item
                        ...
                        style={{ display: 'inline-block', width: '200px' }}
                    >
                        <Input placeholder="value" onChange={(e) => setFlag('sgptValue', e.target.value)} />
                    </Form.Item>
                    <div className="flex-row items-center inline-flex">
                        <Form.Item
                            name="sgptValueFlag"
